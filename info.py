...
API_ID = int(environ.get('API_ID', '28212254'))
API_HASH = environ.get('API_HASH', '7011b357a33338a669e8348d0e4ff46d')
BOT_TOKEN = environ.get('BOT_TOKEN', "7597740692:AAE2CH1LYdkrkwr2U9Fh1Qz5cns7InQ8YTI")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6413364426').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002412980350'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002280516440').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002371586947') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://lazypro:lazypro@cluster0.ykiq6vy.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/omglinks69_new')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'professorr_x') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://professorr_x')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://awake-bellanca-luffyfilter-137c8eac.koyeb.app/")
